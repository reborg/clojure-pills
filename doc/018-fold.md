...
Screencast link: https://youtu.be/c6T-uWShtqQ

Also see chapter 32.1.1 of the [Clojure Standard Library](https://www.manning.com/books/clojure-standard-library) book.

#### summary

* Basic examples
* How does it work? The fork-join model.
* Controlling the computation, chunk size, reducef and combinef.
* Working with hash-maps and r/monoid
* Extended example: word-frequencies
* Foldable reducers and transducers.
* Comparing with pmap and performance details.

![Fork-Join (or reduce-combine) model diagram.](https://github.com/reborg/clojure-pills/blob/master/doc/18-fold-fork-join-model.png)

### At the REPL

```clojure

"Clojure Pills - 018 fold"
